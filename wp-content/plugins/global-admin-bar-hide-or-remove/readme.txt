...
`
BRUTEFORCE PLUGIN INCLUDED ON THIS PAGAGE WAS DISCONTINUED ON 2015-08-31
AND IS NOT LONGER DEVELOPED - ALL FILES COPY WAS DELETED AND REMOVED FROM
ALL DISTIBUTIONS DUE COPYRIGHT INFRINGEMENT ON IT CODING - ALL WAS MOVED
TO LEGITIMATE PACKAGES THAT IS WP-ADMIN BAR REMOVAL - WP-TOOLBAR-REMOVAL
PLEASE USE IT - NO ASSISTANCE AND SUPPORT IS GIVEN FOR BRUTEFORCE PLUGIN
NOW AND FUTURE FOR ANY REASON OF ANY TYPE - CODE IS POETRY AND NOT CLONE
`

DO NOT USE BOTH STANDARD AND BRUTE FORCE PLUGINS AT THE SAME TIME!
...
* Work with all WordPress Versions from 3.1+ to 4.4+
...
latest version of this plugin work on all wordpress version from 3.1+ to 4.4+
